...
import { generateMap, validateMap, createGame } from '../api/index.js';
describe('Map Generation', () => {
    ...
    test('All nodes should touch 1-3 tiles (vertex-degree constraint)', () => {
        ...
        assert.strictEqual(invalidNodes.length, 0, `All nodes must touch 1-3 tiles. Found ${invalidNodes.length} invalid nodes`);
...
//# sourceMappingURL=mapGeneration.test.js.map